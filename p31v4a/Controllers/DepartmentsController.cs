...
namespace ContosoUniversity.Controllers
{
    public class DepartmentsController : Controller
    {
        ...
        {
            var _deparments = _context.Departments.Include(d => d.Administrator).Include(i=>i.Courses);

            var deparments = from d in _deparments select d;
            
            if(!string.IsNullOrEmpty(searchString)) {
                deparments = deparments.Where(d=>d.Name.Contains(searchString));
            }
