// Leer 2 vectores A y B de tamaño n, y multiplicar el primer elemento de A 
// con el ultimo elemento de B
using System;
...
namespace p13vectormultiplica
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("\nDame los elementos A"); leer(A);
            Console.WriteLine("\nDame los elementos B"); leer(B);
